...
class BookingRepository extends BaseRepository
{
    ...
    protected $super_admin_role_id;
    protected $customer_role_id;
    ...
    function __construct(Job $model, MailerInterface $mailer)
    {
        ...
        $this->admin_role_id = Helper::getAdminRoleId();
        $this->super_admin_role_id = Helper::getSuperAdminRoleId();
        $this->customer_role_id = Helper::customerRoleId();
    }
    ...
    public function store($user, $data)
    {
        ...
        if ($user->user_type ==  $this->customer_role_id) {
            $cuser = $user;
            ...
            $data['gender'] = Helper::getGender($data['job_for']);

            $data['certified'] = Helper::getCertification($data['job_for']);

            $data['job_type'] = Helper::getJobType($consumer_type);
    ...
    public function getAll(Request $request, $limit = null)
    {
        ...
        if ($cuser && $cuser->user_type ==  $this->super_admin_role_id) {
            $allJobs = Job::query();

            $this->superAdminSearch($requestdata, $allJobs);
            ...
            $this->NonAdminSearch($requestdata, $allJobs);
    ...
    public function NonAdminSearch($requestdata, $allJobs)
    {
    ...
    public function superAdminSearch($requestdata, $allJobs)
    {
        if (isset($requestdata['feedback']) && $requestdata['feedback'] != 'false') {
            $allJobs->where('ignore_feedback', '0');
            $allJobs->whereHas('feedback', function ($q) {
